                                    ...
                                    <div class="main-menu d-none d-lg-block">
                                        <nav>
                                            <ul id="navigation">                                                                                          
                                                ...
                                                <li><a href="#">Galeri</a>
                                                    <ul class="submenu">
                                                        <li><a href="blog.html">Kopi Enak</a></li>
                                                        <li><a href="blog_details.html">Seduh Kopi</a></li>
                                                        <li><a href="elements.html">Kedai Kopi</a></li>
                                                    </ul>
                                                </li>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12">
                                <div class="hero__caption">
                                    ...
                                    <a href="register.html" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.7s">Join for Free</a>
                                </div>
                            </div>
                        </div>
                    </div>          
                ...
                <div class="left-content2">
                    ...
                    <div class="section-tittle section-tittle2 mb-20">
                        <div class="front-text">
                            ...
                            <a href="register.html" class="btn">Join now for Free</a>
                        </div>
                    </div>
                </div>
            </div>
